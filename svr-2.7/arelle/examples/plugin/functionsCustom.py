...
def customFunctions():
    return {
        ...
        qname(u"{http://www.example.com/wgt-avg/function}my-fn:PDxEV"): test_22015v01_my_fn_PDxEV
    }

__pluginInfo__ = {
    u'name': u'Custom Formula Functions (example)',
    u'version': u'1.0',
    u'description': u"This plug-in adds a custom function implemented by a plug-in.  ",
    ...
    u'Formula.CustomFunctions': customFunctions,
}
