...
def create(modelXbrlFromDTS, modelXbrlToDTS):
    u"""Returns a new modelXbrl representing a Version Report object, by creation of its modelXbrl, its ModelVersReport (modelDocument), and diffing the from and to DTSes 
...
relationshipSetArcAttributesExclusion = set([
    u"{http://www.w3.org/1999/xlink}from",
    u"{http://www.w3.org/1999/xlink}to",
    u"{http://www.w3.org/1999/xlink}actuate",
    u"{http://www.w3.org/1999/xlink}show",
    u"{http://www.w3.org/1999/xlink}title",
    u"{http://www.w3.org/XML/1998/namespace}lang", 
    u"{http://www.w3.org/XML/1998/namespace}space",
    u"id", u"use",u"priority",u"order"])
    
authoritiesEquivalence = {
    u"http://xbrl.iasb.org": u"IFRS", u"http://xbrl.ifrs.org": u"IFRS",
    u"http://xbrl.us": u"XBRL-US", u"http://fasb.org": u"XBRL-US", u"http://xbrl.sec.gov": u"XBRL-US",
    }
    
dateRemovalPattern = re.compile(ur"[/]?(draft-)?(19|20)[0-9][0-9](-[01][0-9](-[0-3][0-9])?)?")
numberRemovalPattern = re.compile(ur"[/]?[0-9][0-9\.]*")
...
class ModelVersReport(ModelDocument.ModelDocument):
    ...
    def close(self, *args, **kwargs):
        u"""Closes any views, formula output instances, modelDocument(s), and dereferences all memory used 
        """
        super(ModelVersReport, self).close(*args, **kwargs)
        
    def versioningReportDiscover(self, rootElement):
        u"""Initiates discovery of versioning report
        ...
        try:
                ...
                if isinstance(modelObject, ModelObject):
                    ...
                    if ns == XbrlConst.ver:
                        if ln == u"action":
                            ...
                            actionRelatedFromMdlObjs = []
                            actionRelatedToMdlObjs = []
                        elif (ln == u"fromDTS" or ln == u"toDTS") and not getattr(self, ln):
                            schemaRefElts = XmlUtil.children(modelObject, XbrlConst.link, u"schemaRef")
                            if schemaRefElts:
                                if len(schemaRefElts) == 1 and schemaRefElts[0].get(u"{http://www.w3.org/1999/xlink}href") is not None:
                                    DTSmodelXbrl = ModelXbrl.load(self.modelXbrl.modelManager,
                                          schemaRefElts[0].get(u"{http://www.w3.org/1999/xlink}href"),
                                          u"loading validation report", 
                                    ...
                                    DTSmodelXbrl = ModelXbrl.create(self.modelXbrl.modelManager, 
                                                 ...
                                                 url=self.uri[:-4] + u"-" + ln + u".dts", isEntry=True)
                                    DTSdoc = DTSmodelXbrl.modelDocument
                                    DTSdoc.inDTS = True
                                    for schemaRefElt in schemaRefElts:
                                        if schemaRefElt.get(u"{http://www.w3.org/1999/xlink}href") is not None:
                                            doc = ModelDocument.load(DTSmodelXbrl,
                                                                     schemaRefElt.get(u"{http://www.w3.org/1999/xlink}href"),
                        ...
                        elif ln in (u"namespaceRename", u"roleChange"):   
                        ...
                        if ln in (u"conceptRename", u"conceptAdd", u"conceptDelete"):
                            if modelAction is not None:
                                modelAction.events.append(modelObject)
                        if ln == u"conceptRename":
                            modelObject.setConceptEquivalence()
                        elif ln == u"conceptDelete":
                            actionRelatedFromMdlObjs.append(modelObject)
                        elif ln == u"conceptAdd":
                            actionRelatedToMdlObjs.append(modelObject)
                    elif ns in (XbrlConst.vercd, XbrlConst.verce):
                        if ln in set([u"conceptIDChange", u"conceptTypeChange", u"conceptSubstitutionGroupChange", 
                                  u"conceptDefaultChange", u"conceptNillableChange",
                                  u"conceptAbstractChange", u"conceptBlockChange", u"conceptFixedChange",
                                  u"conceptFinalChange", u"conceptPeriodTypeChange", u"conceptBalanceChange",
                                  u"conceptAttributeAdd", u"conceptAttributeDelete", u"conceptAttributeChange", 
                                  u"tupleContentModelChange",
                                  u"conceptLabelAdd", u"conceptLabelDelete", u"conceptLabelChange",
                                  u"conceptReferenceAdd", u"conceptReferenceDelete", u"conceptReferenceChange"]):
                            if modelAction is not None:
                                modelAction.events.append(modelObject)
                    elif ns == XbrlConst.verrels:
                        if ln in set([u"relationshipSetModelChange", u"relationshipSetModelAdd", u"relationshipSetModelDelete"]):
                            if modelAction is not None:
                                modelAction.events.append(modelObject)
                            modelRelationshipSetEvent = modelObject
                        elif ln in (u"fromRelationshipSet", u"toRelationshipSet"):
                            if modelRelationshipSetEvent is not None:
                                modelRelationshipSet = modelObject
                                if ln == u"fromRelationshipSet":
                        ...
                        if ln in (u"aspectModelChange", u"aspectModelAdd", u"aspectModelDelete"):
                            if modelAction is not None:
                                modelAction.events.append(modelObject)
                            aspectModelEvent = modelObject
                            modelAspects = None
                        elif ln in (u"fromAspects", u"toAspects"):
                        ...
                        elif ln in (u"concepts", u"explicitDimension", u"typedDimension", u"segment", u"scenario", 
                                    u"entityIdentifier", u"period", u"location", u"unit"):
            ...
            for element in rootElement.iterdescendants(u"{http://www.xbrl.org/2003/linkbase}linkbaseRef"):
    ...
    def diffDTSes(self, reportOutput, fromDTS, toDTS, assignment=u"technical", schemaDir=None):
        u"""Initiates diffing of fromDTS and toDTS, populating the ModelVersReport object, and saving the 
        ...
        :type schemaDir: str
        """
        versReportFile = unicode(reportOutput)  # may be a FileNamedStringIO, in which case str( ) is the filename
        ...
        if u":" in assignment: categoryType = assignment
        elif assignment.startswith(u"technical"): categoryType = u"technicalCategory"
        elif assignment.startswith(u"business"): categoryType = u"businessCategory"
        else: categoryType = u"errataCategory"
        import io
        file = io.StringIO(
            #'<?xml version="1.0" encoding="UTF-8"?>'
            u'<nsmap>'  # for lxml expandable namespace purposes 
            u'<!-- Generated by Arelle(r) version {3} at {4} -->' 
            u'<report' 
            u'  xmlns="http://xbrl.org/2013/versioning-base"' 
            ...
            #'"
            u'>' 
                u'<!-- link:linkbaseRef xlink:type="simple"' 
                u'  xlink:arcrole="http://www.w3.org/1999/xlink/properties/linkbase"' 
                u'  xlink:title="documentation"' 
                u'  xlink:href="sample.xml"/ -->' 
                u'<fromDTS>{0}</fromDTS>' 
                u'<toDTS>{1}</toDTS>' 
                u'<assignment id="versioningTask"><{2}/></assignment>' 
            u'</report></nsmap>'.format(
                u''.join([u'<link:schemaRef xlink:type="simple" xlink:href="{0}"/>'.format(self.relativeUri(uri))
                           for uri in self.entryURIs(fromDTS)]),
                u''.join([u'<link:schemaRef xlink:type="simple" xlink:href="{0}"/>'.format(self.relativeUri(uri))
                           for uri in self.entryURIs(toDTS)]),
                categoryType,
                Version.version,
                format(datetime.datetime.utcnow().strftime(u"%Y-%m-%d %H:%M UTC")))
             )
        ...
        for self.reportElement in  self.xmlDocument.iter(tag=u"{http://xbrl.org/2013/versioning-base}report"):
            self.xmlRootElement = self.reportElement
        self.actionNum = 1
        
        self.modelXbrl.modelManager.showStatus(_(u"Comparing namespaces"))
        self.diffNamespaces()
        self.modelXbrl.modelManager.showStatus(_(u"Comparing roles"))
        self.diffRoles()
        self.modelXbrl.modelManager.showStatus(_(u"Comparing concepts"))
        self.diffConcepts()
        for arcroleUri in (XbrlConst.parentChild, XbrlConst.summationItem, XbrlConst.essenceAlias, XbrlConst.requiresElement, XbrlConst.generalSpecial):
            self.modelXbrl.modelManager.showStatus(_(u"Comparing {0} relationships").format(os.path.basename(arcroleUri)))
            self.diffRelationshipSet(arcroleUri)
            
        self.modelXbrl.modelManager.showStatus(_(u"Comparing dimension defaults"))
        self.diffDimensionDefaults()
        
        self.modelXbrl.modelManager.showStatus(_(u"Comparing explicit dimensions"))
        self.diffDimensions()
        ...
        if schemaDir is not None:
            ...
            for prefix in self.reportElement.nsmap.values():
                if prefix  == XbrlConst.ver:
                    ...
                    schemaLocations.append(schemasRelPath + u"versioning-base.xsd")
                elif prefix  == XbrlConst.vercu:
                    schemaLocations.append(XbrlConst.vercu)
                    schemaLocations.append(schemasRelPath + u"versioning-concept-use.xsd")
                elif prefix  == XbrlConst.vercd:
                    schemaLocations.append(XbrlConst.vercd)
                    schemaLocations.append(schemasRelPath + u"versioning-concept-details.xsd")
                elif prefix  == XbrlConst.verrels:
                    schemaLocations.append(XbrlConst.verrels)
                    schemaLocations.append(schemasRelPath + u"versioning-relationship-sets.xsd")
                elif prefix  == XbrlConst.verdim:
                    schemaLocations.append(XbrlConst.verdim)
                    schemaLocations.append(schemasRelPath + u"versioning-dimensions.xsd")
                elif prefix  == XbrlConst.veria:
                    schemaLocations.append(XbrlConst.veria)
                    schemaLocations.append(schemasRelPath + u"versioning-instance-aspects.xsd")
            self.reportElement.set(u"{http://www.w3.org/2001/XMLSchema-instance}schemaLocation", 
                                   u" ".join(schemaLocations))
        
        self.modelXbrl.modelManager.showStatus(_(u"Checking report file"))
        self.modelXbrl.modelDocument = self # model document is now established
        self.versioningReportDiscover(self.reportElement)
        self.modelXbrl.modelManager.showStatus(_(u"Writing report file"))
        if isinstance(reportOutput, FileNamedStringIO):
            fh = reportOutput
        else:
            fh = open(versReportFile, u"w", encoding=u"utf-8")
        ...
        self.modelXbrl.modelManager.showStatus(_(u"C report file"))
    ...
    def roleNoFromToMatchPattern(self, role):
        ...
        basepart, sep, lastpart = role.rpartition(u"/")
        if lastpart.endswith(u"_to"):
            lastpart = lastpart[:-3]
        elif lastpart.endswith(u"_from"):
            lastpart = lastpart[:-5]
        return UrlUtil.authority(role) + ((sep + lastpart) if lastpart else u"")
    ...
    def diffConcepts(self):
        ...
        for fromConceptQname, fromConcept in self.fromDTS.qnameConcepts.items():
            ...
            if toConceptQname in self.toDTS.qnameConcepts:
                ...
                if fromConcept.id != toConcept.id:
                    action = self.createConceptEvent(vercd, u"vercd:conceptIDChange", fromConcept, toConcept, action, fromValue=fromConcept.id, toValue=toConcept.id)
                if fromConcept.substitutionGroupQname != self.fromDTSqname(toConcept.substitutionGroupQname):
                    action = self.createConceptEvent(vercd, u"vercd:conceptSubstitutionGroupChange", fromConcept, toConcept, action, fromValue=fromConcept.substitutionGroupQname, toValue=self.toDTSqname(toConcept.substitutionGroupQname))
                if fromConcept.isItem and toConcept.isItem:
                    if fromConcept.typeQname != self.fromDTSqname(toConcept.typeQname):
                        action = self.createConceptEvent(vercd, u"vercd:conceptTypeChange", fromConcept, toConcept, action, fromValue=fromConcept.typeQname, toValue=toConcept.typeQname)
                if fromConcept.nillable != toConcept.nillable:
                    action = self.createConceptEvent(vercd, u"vercd:conceptNillableChange", fromConcept, toConcept, action, fromValue=fromConcept.nillable, toValue=toConcept.nillable)
                if fromConcept.abstract != toConcept.abstract:
                    action = self.createConceptEvent(vercd, u"vercd:conceptAbstractChange", fromConcept, toConcept, action, fromValue=fromConcept.abstract, toValue=toConcept.abstract)
                if fromConcept.isItem and toConcept.isItem:
                    if fromConcept.block != toConcept.block:
                        action = self.createConceptEvent(vercd, u"vercd:conceptBlockChange", fromConcept, toConcept, action, fromValue=fromConcept.block, toValue=toConcept.block)
                    if fromConcept.default != toConcept.default:
                        action = self.createConceptEvent(vercd, u"vercd:conceptDefaultChange", fromConcept, toConcept, action, fromValue=fromConcept.default, toValue=toConcept.default)
                    if fromConcept.fixed != toConcept.fixed:
                        action = self.createConceptEvent(vercd, u"vercd:conceptFixedChange", fromConcept, toConcept, action, fromValue=fromConcept.fixed, toValue=toConcept.fixed)
                    if fromConcept.final != toConcept.final:
                        action = self.createConceptEvent(vercd, u"vercd:conceptFinalChange", fromConcept, toConcept, action, fromValue=fromConcept.final, toValue=toConcept.final)
                    if fromConcept.periodType != toConcept.periodType:
                        action = self.createConceptEvent(vercd, u"vercd:conceptPeriodTypeChange", fromConcept, toConcept, action, fromValue=fromConcept.periodType, toValue=toConcept.periodType)
                    if fromConcept.balance != toConcept.balance:
                        action = self.createConceptEvent(vercd, u"vercd:conceptBalanceChange", fromConcept, toConcept, action, fromValue=fromConcept.balance, toValue=toConcept.balance)
                if fromConcept.isTuple and toConcept.isTuple:
                    ...
                    if (fromType is not None and toType is not None and 
                        ...
                        action = self.createConceptEvent(vercd, u"vercd:tupleContentModelChange", fromConcept, toConcept, action)
                ...
                for concept, attrs in ((fromConcept,fromCustAttrs),(toConcept,toCustAttrs)):
                    for attrName, attrValue in concept.items():
                        ...
                        if (attrName not in (u"abstract",u"block",u"default",u"final",u"fixed",u"form",u"id",u"maxOccurs",
                                             u"minOccurs",u"name",u"nillable",u"ref",u"substitutionGroup",u"type") and 
                ...
                for attr in fromCustAttrs.keys():
                    if attr not in toCustAttrs:
                        action = self.createConceptEvent(vercd, u"vercd:conceptAttributeDelete", fromConcept, None, action, fromCustomAttribute=attr, fromValue=fromCustAttrs[attr])
                    elif fromCustAttrs[attr] != toCustAttrs[attr]:
                        action = self.createConceptEvent(vercd, u"vercd:conceptAttributeChange", fromConcept, toConcept, action, fromCustomAttribute=attr, toCustomAttribute=attr, fromValue=fromCustAttrs[attr], toValue=toCustAttrs[attr])
                for attr in toCustAttrs.keys():
                    if attr not in fromCustAttrs:
                        action = self.createConceptEvent(vercd, u"vercd:conceptAttributeAdd", None, toConcept, action, toCustomAttribute=attr, toValue=toCustAttrs[attr])
                        
                # labels, references from each concept
                for event, arcroles in ((u"vercd:conceptLabel", (XbrlConst.conceptLabel, XbrlConst.elementLabel)),
                                        (u"vercd:conceptReference", (XbrlConst.conceptReference, XbrlConst.elementReference))):
                    fromResources = {}
                    toResources = {}
                                ...
                                for rel in resourcesRelationshipSet.fromModelObject(concept):
                                    ...
                                    key = (rel.linkrole, arcrole, resource.role, resource.xmlLang,
                                           ...
                                           XbrlUtil.attributes(dts, rel.arcElement,
                                                exclusions=(XbrlConst.xlink, u"use",u"priority",u"order",u"id")) + \
                    ...
                    for key,label in fromResources.items():
                        ...
                        if key not in toResources:
                            action = self.createConceptEvent(vercd, event + u"Delete", fromConcept, None, action, fromResource=label, fromResourceText=fromText)
                        else:
                            ...
                            if not XbrlUtil.sEqual(self.fromDTS, label, toLabel, excludeIDs=XbrlUtil.ALL_IDs_EXCLUDED, dts2=self.toDTS, ns2ns1Tbl=self.namespaceRenameToURI):
                                action = self.createConceptEvent(vercd, event + u"Change", fromConcept, toConcept, action, fromResource=label, toResource=toResources[key], fromResourceText=fromText, toResourceText=toText)
                    for key,label in toResources.items():
                        toText = XmlUtil.innerText(label)
                        if key not in fromResources:
                            action = self.createConceptEvent(vercd, event + u"Add", None, toConcept, action, toResource=label, toResourceText=toText)

                        

                # 
            else:
                self.createConceptEvent(vercu, u"vercu:conceptDelete", fromConcept=fromConcept)
        for toConceptQname, toConcept in self.toDTS.qnameConcepts.items():
            if ((toConcept.isItem or toConcept.isTuple) and
                ...
                self.createConceptEvent(vercu, u"vercu:conceptAdd", toConcept=toConcept)
    ...
    def diffRelationshipSet(self, arcrole):
        ...
        for dts, linkRoleUris, otherRoleUris, roleChanges, e1, e2, isFrom in (
                        (self.fromDTS, fromLinkRoleUris, toLinkRoleUris, self.roleChangeFromURI, u"relationshipSetModelDelete", u"fromRelationshipSet", True),
                        (self.toDTS, toLinkRoleUris, fromLinkRoleUris, self.roleChangeToURI, u"relationshipSetModelAdd", u"toRelationshipSet", False)):
            for linkRoleUri in linkRoleUris:
                if not (linkRoleUri in otherRoleUris or linkRoleUri in roleChanges):
                    ...
                    for rootConcept in relationshipSet.rootConcepts:
                        ...
                        rs = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=linkRoleUri, arcrole=arcrole)
                        self.createRelationshipSetEvent(u"relationships", eventParent=rs, fromConcept=rootConcept, axis=u"descendant-or-self", comment=u"root relationship")
                    ...
                    for fromRoot in fromRoots:
                        ...
                        if toRootConcept is not None and toRootConcept not in toRoots: # added qname
                            if self.relSetDeletedEvent is None:
                                relSetMdlEvent = self.createRelationshipSetEvent(u"relationshipSetModelDelete")
                                relSetEvent = self.createRelationshipSetEvent(u"fromRelationshipSet", eventParent=relSetMdlEvent)
                                self.relSetDeletedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=linkRoleUri, arcrole=arcrole)
                            self.createRelationshipSetEvent(u"relationships", eventParent=self.relSetDeletedEvent, fromConcept=fromRoot, axis=u"descendant-or-self")
                        else:
                            # check hierarchies
                    ...
                    for toRoot in toRoots:
                        ...
                        if fromRootConcept is not None and fromRootConcept not in fromRoots: # added qname
                            if self.relSetAddedEvent is None:
                                relSetMdlEvent = self.createRelationshipSetEvent(u"relationshipSetModelAdd")
                                relSetEvent = self.createRelationshipSetEvent(u"toRelationshipSet", eventParent=relSetMdlEvent)
                                self.relSetAddedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=toRelationshipSet.linkrole, arcrole=toRelationshipSet.arcrole)
                            self.createRelationshipSetEvent(u"relationships", eventParent=self.relSetAddedEvent, fromConcept=toRoot, axis=u"descendant-or-self", comment=u"root relationship")
        ...
        for i, fromRel in enumerate(fromRels):
            ...
            if toRel is not None and toRel.toModelObject is not None and toRel.toModelObject.qname == toTgtQname:
                ...
                if fromRelAttrs != toRelAttrs:
                    ...
                    relSetMdlEvent = self.createRelationshipSetEvent(u"relationshipSetModelChange")
                    relSetEvent = self.createRelationshipSetEvent(u"fromRelationshipSet", eventParent=relSetMdlEvent)
                    relSetChangedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=fromRelationshipSet.linkrole, arcrole=fromRelationshipSet.arcrole)
                    self.createRelationshipSetEvent(u"relationships", eventParent=relSetChangedEvent, fromConcept=fromConcept, toConcept=fromTgtConcept, attrValues=fromAttrsSet-toAttrsSet)
                    relSetEvent = self.createRelationshipSetEvent(u"toRelationshipSet", eventParent=relSetMdlEvent)
                    relSetChangedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=toRelationshipSet.linkrole, arcrole=toRelationshipSet.arcrole)
                    self.createRelationshipSetEvent(u"relationships", eventParent=relSetChangedEvent, fromConcept=toConcept, toConcept=toRel.toModelObject, attrValues=toAttrsSet-fromAttrsSet)
                else:
                ...
                if self.relSetDeletedEvent is None:
                    relSetMdlEvent = self.createRelationshipSetEvent(u"relationshipSetModelDelete")
                    relSetEvent = self.createRelationshipSetEvent(u"fromRelationshipSet", eventParent=relSetMdlEvent)
                    self.relSetDeletedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=fromRelationshipSet.linkrole, arcrole=fromRelationshipSet.arcrole)
                if toRel is not None:
                    comment = _(u'corresponding relationship {0} toDTS toName="{1}"').format(i+1, XmlUtil.addQnameValue(self.reportElement, toRel.toModelObject.qname))
                else:
                    comment = _(u'toDTS does not have a corresponding relationship at position {0}').format(i+1)
                self.createRelationshipSetEvent(u"relationships", eventParent=self.relSetDeletedEvent, fromConcept=fromConcept, toConcept=fromTgtConcept, comment=comment)
        for i, toRel in enumerate(toRels):
            ...
            if fromRel is None or fromRel.toModelObject is None or fromRel.toModelObject.qname != fromTgtQname:
                ...
                if fromRel is not None:
                    comment = _(u'corresponding relationship {0} toDTS toName="{1}"').format(i+1, XmlUtil.addQnameValue(self.reportElement, fromRel.toModelObject.qname))
                else:
                    comment = _(u'fromDTS does not have a corresponding relationship at position {0}').format(i+1)
                self.createRelationshipSetEvent(u"relationships", eventParent=self.relSetAddedEvent, fromConcept=toConcept, toConcept=toTgtConcept, comment=comment)
    ...
    def diffDimensionDefaults(self):
        ...
        for dts, dimDefaults, otherDimDefaults, otherDTSqname, e1, e2 in (
                        (self.fromDTS, fromDimDefaults, toDimDefaults, self.toDTSqname, u"aspectModelDelete", u"fromAspects"),
                        (self.toDTS, toDimDefaults, fromDimDefaults, self.fromDTSqname, u"aspectModelAdd", u"toAspects")):
            aspectEvent = None
            for fromDimQname, fromDefaultQname in dimDefaults.items():
                ...
                if otherDTSDimQname not in otherDimDefaults or otherDimDefaults[otherDTSDimQname] != otherDTSDefaultQname:
                    ...
                    explDim = self.createInstanceAspectsEvent(u"explicitDimension", ((u'name',fromDimQname),), eventParent=aspectEvent)
    ...
    def diffDimensions(self):
        ...
        for dts, DRSrels, otherDTS, otherDRSrels, otherDTSqname, roleChanges, e1, e2, isFrom in (
                        (self.fromDTS, fromDRSrels, self.toDTS, toDRSrels, self.toDTSqname, self.roleChangeFromURI, u"aspectModelDelete", u"fromAspects", True),
                        (self.toDTS, toDRSrels, self.fromDTS, fromDRSrels, self.fromDTSqname, self.roleChangeToURI, u"aspectModelAdd", u"toAspects", False)):
            aspectEvent = None
            for DRSkey, priItemDRSrels in DRSrels.items():
                ...
                if not otherDTSpriItemDRSrels: #every dim for this pri item is added/removed
                    ...
                    relatedConcepts = self.createInstanceAspectsEvent(u"concepts", eventParent=aspectEvent)
                    priItem = self.createInstanceAspectsEvent(u"concept", ((u'name',priItemQname),), eventParent=relatedConcepts)
                    if priItemInheritRels:
                        priItemNetwork = self.createInstanceAspectsEvent(u"drsNetwork", 
                                                                         ((u'linkrole',linkrole),
                                                                          (u'arcrole',XbrlConst.domainMember),
                                                                          (u'axis', u'descendant-or-self')),
                                                                         eventParent=priItem)
                    for dimRel, isNotAll, isClosed in self.DRSdimRels(dts, priItemDRSrels):
                        dimConcept = dimRel.toModelObject
                        explDim = self.createInstanceAspectsEvent(u"typedDimension" if dimConcept.isTypedDimension else u"explicitDimension", 
                                                                  ((u'name',dimConcept.qname),) + \
                                                                  (((u'excluded',u'true'),) if isNotAll else ()),
                        ...
                        for domRel in self.DRSdomRels(dts, dimRel):
                            ...
                            member = self.createInstanceAspectsEvent(u"member", ((u'name',domRel.toModelObject.qname),), eventParent=explDim)
                            if domHasMemRels:
                                self.createInstanceAspectsEvent(u"drsNetwork",
                                                                ((u'linkrole',domRel.linkrole),
                                                                 (u'arcrole',XbrlConst.domainMember),
                                                                 (u'axis', u'descendant-or-self')),
                                                                eventParent=member)
                    ...
                    if hcDifferences:
                        ...
                        for fromHcRel, toHcRel, fromAttrsSet, toAttrsSet in hcDifferences:
                            relSetEvent = self.createRelationshipSetEvent(u"fromRelationshipSet", eventParent=relSetMdlEvent)
                            relSetChangedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=fromHcRel.linkrole, arcrole=fromHcRel.arcrole)
                            self.createRelationshipSetEvent(u"relationships", eventParent=relSetChangedEvent, fromConcept=fromHcRel.fromModelObject, toConcept=fromHcRel.toModelObject, attrValues=fromAttrsSet-toAttrsSet)
                            relSetEvent = self.createRelationshipSetEvent(u"toRelationshipSet", eventParent=relSetMdlEvent)
                            relSetChangedEvent = self.createRelationshipSetEvent(u"relationshipSet", eventParent=relSetEvent, linkrole=toHcRel.linkrole, arcrole=toHcRel.arcrole)
                            self.createRelationshipSetEvent(u"relationships", eventParent=relSetChangedEvent, fromConcept=toHcRel.toModelObject, toConcept=toHcRel.toModelObject, attrValues=toAttrsSet-fromAttrsSet)
                    ...
                    if priItemDifferences:
                        for fromRel, toRel, fromAttrSet, toAttrSet in priItemDifferences:
                            if fromRel is not None:
                                if toRel is not None: e = u"aspectModelChange"
                                else:                 e = u"aspectModelDelete"
                            else:                     e = u"aspectModelAdd"
                            aspectMdlEvent = self.createInstanceAspectsEvent(e)
                            for priQn, rel, attrSet, e in ((priItemQname, fromRel, fromAttrSet-toAttrSet, u"fromAspects"),
                                                           (otherDTSpriItemQname, toRel, toAttrSet-fromAttrSet, u"toAspects")):
                                if rel is not None:
                                    aspectEvent = self.createInstanceAspectsEvent(e, eventParent=aspectMdlEvent)
                                    priItemInheritRels = dts.relationshipSet(XbrlConst.domainMember, linkrole).fromModelObject(priItemConcept)
                                    relatedConcepts = self.createInstanceAspectsEvent(u"concepts", eventParent=aspectEvent)
                                    priItem = self.createInstanceAspectsEvent(u"concept", ((u'name',priQn),), eventParent=relatedConcepts)
                                    if priItemInheritRels:
                                        self.createInstanceAspectsEvent(u"drsNetwork",
                                                                        ((u'linkrole',rel.linkrole),
                                                                         (u'arcrole',XbrlConst.domainMember),
                                                                         (u'axis', u'descendant-or-self')),
                                                                        eventParent=priItem)
                                    for dimRel, isNotAll, isClosed in self.DRSdimRels(dts, priItemDRSrels):
                    ...
                    if dimsDifferences:
                        for fromDimRel, toDimRel, isNotAll, mbrDiffs in dimsDifferences:
                            if fromDimRel is not None:
                                if toDimRel is not None: e = u"aspectModelChange"
                                else:                    e = u"aspectModelDelete"
                            else:                        e = u"aspectModelAdd"
                            aspectMdlEvent = self.createInstanceAspectsEvent(e)
                            for priQn, dimRel, e, isFrom in ((priItemQname, fromDimRel, u"fromAspects", True),
                                                             (otherDTSpriItemQname, toDimRel, u"toAspects", False)):
                                    ...
                                    if mbrDiffs:
                                        for fromRel, toRel, fromAttrSet, toAttrSet in mbrDiffs:
                                            ...
                                            if rel is not None:
                                                ...
                                                member = self.createInstanceAspectsEvent(u"member", ((u'name',rel.toModelObject.qname),), eventParent=explDim)
                                                if domHasMemRels:
                                                    self.createInstanceAspectsEvent(u"drsNetwork",
                                                                                    ((u'linkrole',rel.linkrole),
                                                                                     (u'arcrole',XbrlConst.domainMember),
                                        ...
                                        for domRel in self.DRSdomRels(dts, dimRel):
                                            domHasMemRels = dts.relationshipSet(XbrlConst.domainMember, linkrole).fromModelObject(priItemConcept)
                                            self.createInstanceAspectsEvent(u"member", ((u'name',domRel.toModelObject.qname),) + \
                                                                                      (((u'linkrole',domRel.linkrole),
                                                                                        (u'arcrole',XbrlConst.domainMember),
                                                                                        (u'axis', u'DRS-descendant-or-self')) if domHasMemRels else ()),
                                                                                      eventParent=explDim)
    ...
    def typedDomainElementComment(self, dimConcept):
        if dimConcept.isTypedDimension:
            if dimConcept.typedDomainElement is not None:
                return _(u'typed domain element {0}').format(dimConcept.typedDomainElement.qname)
            else:
                return _(u'typedDomainRef={0} (element qname cannot be determined)').format(dimConcept.typedDomainRef)
        return None
    ...
    def createAction(self):
        action = XmlUtil.addChild(self.reportElement, XbrlConst.ver, u"ver:action", ((u"id",u"action{0:05}".format(self.actionNum) ),))
        self.actionNum += 1
        assignmentRef = XmlUtil.addChild(action, XbrlConst.ver, u"ver:assignmentRef", ((u"ref",u"versioningTask"),) )
        return action
    
    def createBaseEvent(self, eventName, fromURI, toURI):
        event = XmlUtil.addChild(self.createAction(), XbrlConst.ver, eventName)
        XmlUtil.addChild(event, XbrlConst.ver, u"ver:fromURI", (u"value",fromURI))
        XmlUtil.addChild(event, XbrlConst.ver, u"ver:toURI", (u"value",toURI))
    ...
    def createConceptEvent(self, eventNS, eventName, fromConcept=None, toConcept=None, action=None, fromCustomAttribute=None, toCustomAttribute=None, fromResource=None, toResource=None, fromValue=None, toValue=None, fromResourceText=None, toResourceText=None):
        ...
        if fromConcept is not None:
            ...
            fromElt = XmlUtil.addChild(event, XbrlConst.vercu, u"vercu:fromConcept", (u"name", fromQname) )
        if fromValue is not None:
            XmlUtil.addComment(event, _(u"from value: {0} ").format(fromValue))
        if fromResource is not None:
            fromResElt = XmlUtil.addChild(event, XbrlConst.vercd, u"vercd:fromResource", (u"value",self.conceptHref(fromResource)) )
            if fromResource.id is None and fromConcept is not None:
                XmlUtil.addComment(event, _(u"({0} does not have an id attribute)").format(eventName))
            if fromResourceText:
        ...
        if fromCustomAttribute is not None:
            if fromCustomAttribute.namespaceURI:  # has namespace
                ...
                XmlUtil.addChild(event, XbrlConst.vercd, u"vercd:fromCustomAttribute", ((u"name",attQname),) )
            else: # no namespace
                XmlUtil.addChild(event, XbrlConst.vercd, u"vercd:fromCustomAttribute", ((u"name",fromCustomAttribute.localName),) )
        if toConcept is not None:
            toQname = XmlUtil.addQnameValue(self.reportElement, toConcept.qname)
            toElt = XmlUtil.addChild(event, XbrlConst.vercu, u"vercb:toConcept", (u"name", toQname) )
        if toValue is not None:
            XmlUtil.addComment(event, _(u"to value: {0} ").format(toValue))
        if toResource is not None:
            toResElt = XmlUtil.addChild(event, XbrlConst.vercd, u"vercd:toResource", (u"value",self.conceptHref(toResource)) )
        ...
        if toCustomAttribute is not None:
            if toCustomAttribute.namespaceURI:  # has namespace
                ...
                XmlUtil.addChild(event, XbrlConst.vercd, u"vercd:toCustomAttribute", ((u"name",attQname),) )
            else: # no namespace
                XmlUtil.addChild(event, XbrlConst.vercd, u"vercd:toCustomAttribute", ((u"name",toCustomAttribute.localName),) )
            
        return action
            
    def conceptHref(self, concept):
        return self.relativeUri(concept.modelDocument.uri) + u"#" + XmlUtil.elementFragmentIdentifier(concept) 
    ...
    def createRelationshipSetEvent(self, eventName, linkrole=None, arcrole=None, fromConcept=None, toConcept=None, axis=None, attrValues=None, comment=None, eventParent=None):
        ...
        eventAttributes = []
        if linkrole:
            eventAttributes.append((u"linkrole", linkrole))
        if arcrole:
            eventAttributes.append((u"arcrole", arcrole))
        if fromConcept is not None:
            eventAttributes.append((u"fromName", XmlUtil.addQnameValue(self.reportElement, fromConcept.qname)))
        if toConcept is not None:
            eventAttributes.append((u"toName", XmlUtil.addQnameValue(self.reportElement, toConcept.qname)))
        if axis:
            eventAttributes.append((u"axis", axis))
        eventElement = XmlUtil.addChild(eventParent, XbrlConst.verrels, u"verrels:" + eventName, attributes=eventAttributes)
        if comment:
            XmlUtil.addComment(eventParent, u' ' + comment + u' ')
        if attrValues:
            XmlUtil.addComment(eventParent, u' ' + u', '.join(u"{0[0]}='{0[1]}'".format(a) for a in sorted(attrValues)) + u' ')
        return eventElement
        
    def createInstanceAspectsEvent(self, eventName, eventAttributes=None, comment=None, eventParent=None):
        if eventParent is None:
            eventParent = self.createAction()
        eventElement = XmlUtil.addChild(eventParent, XbrlConst.verdim, u"verdim:" + eventName, 
