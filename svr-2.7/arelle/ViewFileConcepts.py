...
def viewConcepts(modelXbrl, outFile, labelrole=None, lang=None):
    modelXbrl.modelManager.showStatus(_(u"viewing concepts"))
...
class ViewConcepts(ViewFile.View):
    def __init__(self, modelXbrl, outFile, labelrole, lang):
        super(ViewConcepts, self).__init__(modelXbrl, outFile, u"concepts", lang)
    ...
    def view(self, modelDocument):
        ...
        # header
        headings = [u"Label",u"Name",u"ID",u"Abs\u00ADtract",u"Substi\u00ADtu\u00ADtion Group",u"Type",u"Per\u00ADiod Type", u"Bal\u00ADance"]
        if hasDifferentNillables:
            headings.append(u"Nillable")
        if hasTypedDomainRef:
            headings.append(u"Typed Domain Ref")
        headings.append(u"Facets")
        headings.append(u"Doc\u00ADu\u00ADmen\u00ADta\u00ADtion")
